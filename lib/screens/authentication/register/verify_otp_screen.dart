...
import 'package:sapaid/controllers/authentication/register/verify_otp_controller.dart';
import 'package:sapaid/widgets/common_dialog_widget.dart';
                ...
                child: CommonButton(
                    ...
                    onPressed: () {
                      if (_.otpController.text.length < 4) {
                        ...
                        CommonConfirmationDialog.showConfirmationDialog(
                            onButtonPressed: () {
                            ...
                            image: AppAssets.accountcreated);
                      }
